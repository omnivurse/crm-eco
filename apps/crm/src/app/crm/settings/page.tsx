...
const settingsCards: SettingCard[] = [
  {
    ...
    description: 'Centralized settings for all CRM modules',
    href: '/crm/settings/configuration',
  ...
  },
  {
    ...
    description: 'Roles, permissions, SSO, trusted domains, and login history',
  ...
  {
    title: 'Channels Hub',
    description: 'Email, SMS, telephony, chat, social, and portal channels',
  ...
  {
    title: 'Customization',
    description: 'Modules, fields, field options, layouts, and validation rules',
  ...
  },
  {
    ...
    description: 'Pipelines, stages, required fields, and stage permissions',
  ...
  {
    title: 'Marketplace',
    description: 'Browse, install, and manage extensions and integrations',
    href: '/crm/settings/marketplace',
  ...
  {
    title: 'Developer Hub',
    description: 'API keys, outbound webhooks, and request logs',
  ...
  },
  {
    ...
    description: 'Workflows, triggers, assignment rules, scoring, cadences, and SLAs',
