...
// Roles that can use saved views for tickets
...
/**
 * Create a new saved view for the Tickets Board
 */
export async function createTicketsSavedView(params: {
  name: string;
...
/**
 * Set a saved view as the default for the Tickets Board
 */
export async function setTicketsSavedViewDefault(viewId: string): Promise<ActionResult> {
  try {
    const profile = await verifyAccess();
    const supabase = await createServerSupabaseClient();
...
/**
 * Clear the default view for the Tickets Board
 */
export async function clearTicketsSavedViewDefault(): Promise<ActionResult> {
  try {
    const profile = await verifyAccess();
    const supabase = await createServerSupabaseClient();
...
/**
 * Delete a saved view for the Tickets Board
 */
export async function deleteTicketsSavedView(viewId: string): Promise<ActionResult> {
  try {
    const profile = await verifyAccess();
    const supabase = await createServerSupabaseClient();
