...
export const CONTACTS_FIELD_MAPPING: FieldMapping[] = [
  ...
  { csvColumn: 'Phone Belongs To', crmKey: 'phone_owner', type: 'text', section: 'core' },
  { csvColumn: 'Phone Owner Name', crmKey: 'phone_owner_name', type: 'text', section: 'core' },
  { csvColumn: 'Mobile', crmKey: 'mobile', type: 'phone', section: 'core' },
  { csvColumn: 'Mobile Belongs To', crmKey: 'mobile_owner', type: 'text', section: 'core' },
  { csvColumn: 'Mobile Owner Name', crmKey: 'mobile_owner_name', type: 'text', section: 'core' },
  { csvColumn: 'Work Phone', crmKey: 'work_phone', type: 'phone', section: 'core' },
  { csvColumn: 'Work Phone Belongs To', crmKey: 'work_phone_owner', type: 'text', section: 'core' },
  { csvColumn: 'Fax', crmKey: 'fax', type: 'phone', section: 'core' },
  { csvColumn: 'Phone 2', crmKey: 'phone2', type: 'phone', section: 'core' },
  { csvColumn: 'Phone 2 Belongs To', crmKey: 'phone2_owner', type: 'text', section: 'core' },
  { csvColumn: 'Phone 2 Owner Name', crmKey: 'phone2_owner_name', type: 'text', section: 'core' },
  { csvColumn: 'Mobile 2', crmKey: 'mobile_2', type: 'phone', section: 'contact' },
  { csvColumn: 'Mobile 2 Belongs To', crmKey: 'mobile_2_owner', type: 'text', section: 'contact' },
  { csvColumn: 'Mobile 2 Owner Name', crmKey: 'mobile_2_owner_name', type: 'text', section: 'contact' },
  { csvColumn: 'Date of Birth', crmKey: 'date_of_birth', type: 'date', section: 'core', transform: parseDate },
  // 'Birth Month' retired (migration 202607140002): derivable from Date of Birth; no longer mapped.
