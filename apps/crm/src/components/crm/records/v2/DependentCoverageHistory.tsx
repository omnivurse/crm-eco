...
export const DependentCoverageHistory = memo(function DependentCoverageHistory({
  memberId,
  className,
  readOnly = false,
  ...
  const handleCoverageActionSave = async () => {
    ...
    try {
      let result;
      if (mode === 'end') {
        result = await crmEndDependentCoverage({
          member_id: memberId,
        ...
        result = await crmStartDependentCoverage({
          member_id: memberId,
          dependent_id: dependent.id,
        ...
        result = await crmLogHistoricalCoveragePeriod({
          member_id: memberId,
          dependent_id: dependent.id,
          effective_from: coverageForm.date,
  ...
  const handleAddDependent = async () => {
    ...
    setSaving(true);
    try {
      const result = await crmAddDependentWithCoverage({
        member_id: memberId,
