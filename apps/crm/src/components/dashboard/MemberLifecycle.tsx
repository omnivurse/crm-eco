...
import type { PipelineCounts } from '@/lib/crm/queries';
...
interface MemberLifecycleProps {
  counts: PipelineCounts;
}

/**
 * MemberLifecycle -- Horizontal lifecycle funnel for CRM dashboard.
 * Shows Leads -> Draft -> In Progress -> Submitted -> Active with counts.
 */
export function MemberLifecycle({ counts }: MemberLifecycleProps) {
