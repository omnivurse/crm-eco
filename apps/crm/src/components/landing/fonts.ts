 ...
 *
 * These are loaded here — NOT in `app/layout.tsx` — so the marketing landing
 * gets its display/ledger voice without changing a byte of the CRM shell's
 * type. The variables are applied on the landing root only.
 *
 ...
 * app's existing heading face rather than breaking the page.
 */
