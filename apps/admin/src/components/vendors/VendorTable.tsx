      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-slate-200">
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Vendor</th>
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Code</th>
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Type</th>
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Connection</th>
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Status</th>
            <th className="text-left py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Last Sync</th>
            <th className="text-right py-[var(--ui-cell-py)] px-4 text-sm font-semibold text-slate-600">Actions</th>
          </tr>
        </thead>
        <tbody>
          {vendors.map((vendor) => (
            <tr key={vendor.id} className="border-b border-slate-100 hover:bg-slate-50">
              <td className="py-[var(--ui-cell-py)] px-4">
