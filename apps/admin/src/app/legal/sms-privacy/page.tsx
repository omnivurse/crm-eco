...
export const metadata: Metadata = {
  title: 'SMS Privacy Policy | Double Helix Admin',
  description:
    'How we collect, use, and protect information related to text message campaigns.',
};

export default function AdminSmsPrivacyPage() {
  return (
      ...
      <header className="border-b border-black/10 px-6 py-4 dark:border-white/10">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="rounded-full border border-cyan-500/20 bg-cyan-500/10 px-2 py-0.5 font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-cyan-700 dark:text-cyan-400">
              MMS
            </span>
          </Link>
          <Link
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
        ...
        <div className="mt-10 rounded-3xl border border-black/10 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-black/40 sm:p-8">
          <SmsPrivacyPolicy
            ...
            className="[&_a]:text-emerald-700 dark:[&_a]:text-emerald-400"
          />
        </div>
