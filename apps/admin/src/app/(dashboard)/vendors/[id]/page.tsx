...
export default async function VendorDetailPage({
  ...
  const { vendor, files, changes, connectors } = data;
            ...
            <CardContent className="space-y-4">
              ...
              {vendor.sync_enabled && (
                <>
                  ...
                  {vendor.sync_schedule && (
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-slate-500">Schedule</span>
                      <code className="text-xs bg-slate-100 px-2 py-0.5 rounded">{vendor.sync_schedule}</code>
                    </div>
                  )}
                  {vendor.last_sync_at && (
                    <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-slate-500">
                                {file.file_type} · {file.processed_rows}/{file.total_rows} rows
                                {file.error_rows > 0 && (
                                  <span className="text-red-500 ml-2">({file.error_rows} errors)</span>
                                )}
                              </p>
                            </div>
                          </div>
