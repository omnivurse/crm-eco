          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 sm:p-8">
            ...
            <Link href="/enroll" className="block">
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 text-sm font-medium rounded-xl border-slate-200 hover:border-[#047474]/30 hover:bg-[#047474]/5 text-slate-700 transition-all duration-200"
              >
                <span className="flex items-center gap-2">
                  New member? Start your enrollment
