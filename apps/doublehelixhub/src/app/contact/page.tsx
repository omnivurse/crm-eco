          ...
          <div className="mt-10 space-y-4">
            <div className="dh-bezel">
              <div className="dh-bezel-inner p-6">
                <h3 className="font-heading text-sm font-semibold text-white">For partners & licensees</h3>
            ...
            <div className="dh-bezel">
              <div className="dh-bezel-inner p-6">
                <h3 className="font-heading text-sm font-semibold text-white">For members</h3>
                <p className="mt-2 text-sm leading-relaxed text-white/50">
