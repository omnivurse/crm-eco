      ...
      <CardContent className="space-y-6">
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <p className="text-sm text-blue-800 mb-4">
            ...
            By checking the box below, you authorize Double Helix Hub and its partners to obtain
          ...
          <div className="flex items-start gap-3">
            ...
            <Label htmlFor="consent" className="text-sm font-normal leading-relaxed cursor-pointer">
              I authorize Double Helix Hub and its partners to obtain medical records related to this
      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
          ...
          <p className="text-sm text-green-800">
            You have authorized Double Helix Hub to obtain medical records related to this Need.
          </p>
        </div>
