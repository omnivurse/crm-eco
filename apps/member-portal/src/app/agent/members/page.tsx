  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <Users weight="light" className="h-12 w-12 animate-pulse text-slate-400" />
      </div>
    );
  }
        ...
        <CardContent>
          {paginatedMembers.length === 0 ? (
            <div className="text-center py-12">
              <Users weight="light" className="h-12 w-12 mx-auto mb-4 text-slate-300" />
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {member.email && (
                                <DropdownMenuItem onClick={() => window.location.href = `mailto:${member.email}`}>
                                  <Envelope weight="light" className="mr-2 h-4 w-4" />
                                  Send Email
                                </DropdownMenuItem>
                              )}
                              {member.phone && (
                                <DropdownMenuItem onClick={() => window.location.href = `tel:${member.phone}`}>
                                  <Phone weight="light" className="mr-2 h-4 w-4" />
                                  Call
                                </DropdownMenuItem>
                              )}
                            </DropdownMenuContent>
