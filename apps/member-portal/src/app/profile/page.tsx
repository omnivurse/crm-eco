...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    // Persist via a server action: `members` has no member self-update RLS, so a
    // client-side update would silently save nothing. The action uses the
    // service role with ownership verified by the auth gate, and confirms a row
    // was written so a failure surfaces instead of a fake success.
