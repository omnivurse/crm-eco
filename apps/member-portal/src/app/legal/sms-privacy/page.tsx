...
export const metadata: Metadata = {
  title: 'SMS Privacy Policy | Member Portal',
  description:
    'How we collect, use, and protect information related to text message campaigns.',
};

export default function MemberSmsPrivacyPage() {
  return (
    <div className="min-h-screen bg-slate-50 px-6 py-12 text-slate-900">
      <main className="mx-auto max-w-3xl">
        <Link href="/signin" className="text-sm font-medium text-cyan-700 hover:underline">
          ← Back to sign in
        </Link>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 sm:p-8">
          <SmsPrivacyPolicy
            brand={{
              companyName: 'Pay It Forward Health',
              contactEmail: 'privacy@payitforwardhealth.com',
              supportEmail: 'support@payitforwardhealth.com',
            }}
