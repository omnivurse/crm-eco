...
This document describes the complete GoTo Connect integration for the Double Helix Hub IT Help Desk system. The integration provides a full-featured call center solution with real-time call handling, automatic ticket creation, call recording, and comprehensive agent management.
...
This integration is part of the Double Helix Hub IT Help Desk system and follows the same license terms.
