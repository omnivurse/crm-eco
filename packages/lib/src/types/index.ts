...
export type Dependent = TableRow<'dependents'>;
export type DependentCoveragePeriod = TableRow<'dependent_coverage_periods'>;
...
export type EmailSendOutbox = TableRow<'email_send_outbox'>;
export type ProviderInboundEvent = TableRow<'provider_inbound_events'>;
export type CommunicationRecordLink = TableRow<'communication_record_links'>;
export type MessageParticipant = TableRow<'message_participants'>;
export type CommsSyncCursor = TableRow<'comms_sync_cursors'>;
export type CommsDeadLetter = TableRow<'comms_dead_letters'>;
export type InboxInternalNote = TableRow<'inbox_internal_notes'>;
