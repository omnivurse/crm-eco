  ...
  public: {
    Tables: {
      ...
      agent_call_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_call_status_active_call_id_fkey"
      ...
      call_logs: {
        Row: {
          ...
          goto_conversation_space_id: string | null
          id: string
          metadata: Json | null
          notes: string | null
          outcome: string | null
          recipient_phone: string
          recording_transcription: string | null
      ...
      call_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "call_participants_call_log_id_fkey"
            columns: ["call_log_id"]
            isOneToOne: false
            referencedRelation: "call_logs"
            referencedColumns: ["id"]
      ...
      crm_scheduled_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "crm_scheduled_reports_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      daily_log_entries: {
        Row: {
          ...
          description: string
          duration_minutes: number | null
          entry_type: Database["public"]["Enums"]["daily_log_entry_type"]
          id: string
          metadata: Json | null
          updated_at: string
          user_id: string
      ...
      daily_log_reports: {
        Row: {
          ...
          email_status: Database["public"]["Enums"]["daily_log_email_status"]
          error_message: string | null
          id: string
          recipient_email: string
          report_data: Json | null
          report_type: Database["public"]["Enums"]["daily_log_report_type"]
          retry_count: number
          updated_at: string
          user_id: string
        }
        ...
        Relationships: [
          {
            foreignKeyName: "daily_log_reports_daily_log_id_fkey"
            columns: ["daily_log_id"]
            isOneToOne: false
            referencedRelation: "daily_logs"
            referencedColumns: ["id"]
      ...
      email_delivery_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_delivery_tracking_notification_id_fkey"
            columns: ["notification_id"]
            isOneToOne: false
            referencedRelation: "ticket_email_notifications"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      files: {
        Row: {
          ...
          onedrive_last_sync_at: string | null
          onedrive_metadata: Json | null
          onedrive_sync_status: string | null
          owner_id: string
      ...
      goto_settings: {
        Row: {
          ...
          auto_ticket_creation: boolean | null
      ...
      inbox_assignments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inbox_assignments_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      inbox_quick_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "inbox_quick_actions_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "inbox_conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inbox_quick_actions_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      ticket_links: {
        Row: {
          ...
          created_by: string | null
          id: string
          link_type: Database["public"]["Enums"]["ticket_link_type"]
          notes: string | null
      ...
      unified_audit_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "unified_audit_logs_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      ci_class:
        ...
        | "service"
        | "other"
      daily_log_email_status: "pending" | "sent" | "failed" | "bounced"
      daily_log_entry_type:
        | "task"
        | "meeting"
        | "blocker"
        | "note"
        ...
        | "break"
        | "other"
      daily_log_report_type: "end_of_day" | "manual" | "scheduled"
