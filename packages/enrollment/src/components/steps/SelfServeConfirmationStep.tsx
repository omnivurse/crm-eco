...
import type { WizardSnapshot, WizardPlan } from '../../types';
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-slate-600 mb-8 max-w-md mx-auto">
          Thank you for enrolling with Pay It Forward Health. Your application has been submitted
      ...
      <Card className="bg-slate-50">
        <CardContent className="pt-6">
          <p className="text-sm text-slate-600">
            ...
            Pay It Forward Health health sharing program. Your application will be reviewed and you
