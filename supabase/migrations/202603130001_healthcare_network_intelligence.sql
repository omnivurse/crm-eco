...
BEGIN
  ...
  VALUES
    (v_org_id, 'PIFH-PPO-FL', 'Pay It Forward Health PPO Network - Florida', 'ppo',
     'Broad PPO network covering major Florida metros', ARRAY['FL']),
    (v_org_id, 'PIFH-HMO-FL', 'Pay It Forward Health HMO Network - Florida', 'hmo',
     'Managed care HMO network in Tampa Bay and Orlando', ARRAY['FL']),
    (v_org_id, 'PIFH-PREF-FL', 'Pay It Forward Health Preferred Provider Network', 'preferred',
