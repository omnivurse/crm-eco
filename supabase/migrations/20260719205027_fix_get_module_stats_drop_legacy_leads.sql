...
-- This migration was applied directly to production on 2026-07-19 20:50:27 UTC
...
-- get_module_stats referenced public.leads which was removed (crm_records is source of truth).
-- Keep members legacy rollup; drop leads CTE.
