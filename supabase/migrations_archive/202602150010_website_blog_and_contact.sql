...
(
  ...
  'The Johnson family of four was paying over $1,800 per month for traditional health insurance. When they discovered Double Helix Hub, they found a community-driven alternative that cut their monthly costs by more than half while providing the coverage they needed.',
  'Community Stories',
  'Double Helix Hub Team',
  'published',
  now() - interval '7 days'
...
(
  ...
  'At Double Helix Hub, we believe in caring for the whole person. That''s why our plans include mental health sharing benefits, and we''re continually expanding our wellness resources to support your emotional well-being.',
  'Wellness',
  'Double Helix Hub Team',
  'published',
  now() - interval '1 day'
...
(
  ...
  'Preventive care is a cornerstone of good health. Regular check-ups, screenings, and vaccinations can catch problems early and keep you healthier in the long run. Here''s what''s covered under your Double Helix Hub membership.',
  'Health Tips',
  'Double Helix Hub Team',
  'published',
  now()
