...
BEGIN
  ...
  VALUES
    (v_org_id, 'PIFH Health Center - Tampa',       'clinic',    '4200 W Kennedy Blvd',  'Tampa',         'FL', '33609', 27.9475, -82.5084, '(813) 555-0100', true, true),
    (v_org_id, 'PIFH Health Center - Orlando',      'clinic',    '1200 S Orange Ave',    'Orlando',       'FL', '32806', 28.5255, -81.3790, '(407) 555-0200', true, true),
    (v_org_id, 'PIFH Health Center - Miami',        'clinic',    '1611 NW 12th Ave',     'Miami',         'FL', '33136', 25.7907, -80.2103, '(305) 555-0300', true, true),
    (v_org_id, 'PIFH Health Center - Jacksonville', 'clinic',    '655 W 8th St',         'Jacksonville',  'FL', '32209', 30.3521, -81.6723, '(904) 555-0400', true, true),
    (v_org_id, 'PIFH Telehealth Hub',               'virtual',   NULL,                    'Nationwide',    'FL', '00000', NULL,    NULL,     '(800) 555-0500', true, true)
  ...
  LOOP
    SELECT id INTO v_loc_id FROM healthcare_locations WHERE organization_id = v_org_id AND name = 'PIFH Telehealth Hub' LIMIT 1;
