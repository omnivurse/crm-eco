...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = '_import_contacts_staging')
     AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = '_import_contacts_staging' AND policyname = 'service_role_import_contacts_staging')
  THEN
    EXECUTE 'CREATE POLICY "service_role_import_contacts_staging"
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = '_import_leads_staging')
     AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = '_import_leads_staging' AND policyname = 'service_role_import_leads_staging')
  THEN
    EXECUTE 'CREATE POLICY "service_role_import_leads_staging"
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = '_import_notes_staging')
     AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = '_import_notes_staging' AND policyname = 'service_role_import_notes_staging')
  THEN
    EXECUTE 'CREATE POLICY "service_role_import_notes_staging"
