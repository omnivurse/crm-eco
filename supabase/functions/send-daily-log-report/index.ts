...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const fromEmail = Deno.env.get("FROM_EMAIL") || "reports@mail.payitforwardhealth.com";
    const recipientEmail = Deno.env.get("REPORT_RECIPIENT_EMAIL") || "reports@mail.payitforwardhealth.com";
...
function generateTextReport(
  ...
  text += `\n${"=".repeat(60)}\n`;
  text += `Report generated automatically by Pay It Forward Health\n`;
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; color: #6b7280; font-size: 13px; text-align: center; line-height: 1.6;">
                This report was automatically generated by Pay It Forward Health.<br>
