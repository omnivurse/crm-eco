// Terminal Provider - Starship Command Center
import React, { createContext, useContext, useCallback, useReducer, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { supabase } from '@/lib/supabase';
import { useAuth } from '@/providers/AuthProvider';
import { useTheme } from '@/providers/ThemeProvider';
import type { TerminalContextValue, TerminalState, CommandResult, PanelType } from '@/lib/terminal/types';
import { executeCommand, getSuggestions as getCommandSuggestions } from '@/lib/terminal/command-registry';
...
export function TerminalProvider({ children }: { children: React.ReactNode }) {
  ...
  }, [profile, navigate, setPanel, clearOutput, theme, toggleTheme]);
