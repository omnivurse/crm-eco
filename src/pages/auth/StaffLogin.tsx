  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (profile?.role && ['staff', 'concierge', 'admin', 'agent', 'super_admin'].includes(profile.role)) {
          navigate('/dashboard');
        } else {
          setError('Invalid email or password. Please try again.');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-900 flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="championship-title text-3xl mb-2" data-text="Staff Portal">
            Staff Portal
          </h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-white/20 dark:border-white/10 rounded-xl bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm text-neutral-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border-2 border-white/20 dark:border-white/10 rounded-xl bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm text-neutral-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all"
