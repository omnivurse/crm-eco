        ...
        <div className="cta-content">
          ...
          >
            ...
            <p className="cta-description">
              Join hundreds of healthcare organizations delivering exceptional service with Double Helix Hub
            </p>
      ...
      <footer className="bg-neutral-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-neutral-400">
            <a href="mailto:support@doublehelixhub.com" className="hover:text-white transition-colors">
