...
import { Mail, Phone, User, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function MemberPortal() {
  ...
  if (success) {
    return (
      <div className="min-h-screen public-background flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl p-8 text-center">
          ...
          <p className="text-3xl font-bold text-primary-800 dark:text-primary-500 mb-6">
            #{ticketNumber}
          </p>
          <p className="text-neutral-600 dark:text-neutral-300 mb-8">
            We've sent a confirmation email to <strong>{formData.email}</strong>. Our team will review your request and get back to you shortly.
          </p>
          <button
            onClick={() => window.location.reload()}
            className="w-full py-3 px-6 bg-primary-800 hover:bg-primary-900 text-white font-semibold rounded-lg transition-colors"
          >
  ...
  return (
    <div className="min-h-screen public-background">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 px-6 bg-primary-800 hover:bg-primary-900 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors"
              >
